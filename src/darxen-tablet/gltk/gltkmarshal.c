...
/* NONE:STRING,STRING (gltkmarshal.list:7) */
void
...
/* NONE:STRING,POINTER (gltkmarshal.list:8) */
void
...
/* NONE:STRING,STRING,POINTER (gltkmarshal.list:9) */
void
...
/* NONE:STRING,POINTER,STRING (gltkmarshal.list:10) */
void
g_cclosure_user_marshal_VOID__STRING_POINTER_STRING (GClosure     *closure,
                                                     ...
                                                     gpointer      marshal_data)
{
  typedef void (*GMarshalFunc_VOID__STRING_POINTER_STRING) (gpointer     data1,
                                                            gpointer     arg_1,
                                                            gpointer     arg_2,
                                                            gpointer     arg_3,
                                                            gpointer     data2);
  register GMarshalFunc_VOID__STRING_POINTER_STRING callback;
  register GCClosure *cc = (GCClosure*) closure;
  register gpointer data1, data2;
  ...
  callback = (GMarshalFunc_VOID__STRING_POINTER_STRING) (marshal_data ? marshal_data : cc->callback);
...
/* NONE:NONE (gltkmarshal.list:11) */

/* POINTER:INT,INT (gltkmarshal.list:12) */
void
...
/* POINTER:STRING (gltkmarshal.list:13) */
void
g_cclosure_user_marshal_POINTER__STRING (GClosure     *closure,
                                         ...
                                         gpointer      marshal_data)
{
  typedef gpointer (*GMarshalFunc_POINTER__STRING) (gpointer     data1,
                                                    gpointer     arg_1,
                                                    gpointer     data2);
...
/* POINTER:STRING,POINTER (gltkmarshal.list:14) */
void
g_cclosure_user_marshal_POINTER__STRING_POINTER (GClosure     *closure,
                                                 ...
                                                 gpointer      marshal_data)
{
  typedef gpointer (*GMarshalFunc_POINTER__STRING_POINTER) (gpointer     data1,
                                                            gpointer     arg_1,
                                                            gpointer     arg_2,
                                                            gpointer     data2);
  register GMarshalFunc_POINTER__STRING_POINTER callback;
  register GCClosure *cc = (GCClosure*) closure;
  register gpointer data1, data2;
  gpointer v_return;
  ...
  callback = (GMarshalFunc_POINTER__STRING_POINTER) (marshal_data ? marshal_data : cc->callback);
...
/* POINTER:STRING,BOXED (gltkmarshal.list:15) */
void
g_cclosure_user_marshal_POINTER__STRING_BOXED (GClosure     *closure,
                                               ...
                                               gpointer      marshal_data)
{
  typedef gpointer (*GMarshalFunc_POINTER__STRING_BOXED) (gpointer     data1,
                                                          gpointer     arg_1,
                                                          gpointer     arg_2,
                                                          gpointer     data2);
  register GMarshalFunc_POINTER__STRING_BOXED callback;
  register GCClosure *cc = (GCClosure*) closure;
  register gpointer data1, data2;
  gpointer v_return;
  ...
  callback = (GMarshalFunc_POINTER__STRING_BOXED) (marshal_data ? marshal_data : cc->callback);
...
/* NONE:STRING,POINTER (gltkmarshal.list:16) */
